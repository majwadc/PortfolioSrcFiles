    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/bf33fd66-9624-4d35-9fce-519e7af227ed" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>Reach out to me on <a className='text-blue-600 py-4' href="https://www.linkedin.com/in/mohdajwad/"> LinkedIn </a> </p>
                <p className='text-gray-300 py-4'>Shoot me an email - majwadc@gmail.com</p>
            </div>
